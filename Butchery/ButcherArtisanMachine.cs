...
namespace Butchery
{
    ...
    public class ButcherArtisanMachine : StardewValley.Object
    {
        /*
        ...
        */
        ...
        public static Rectangle getSourceRectForButcheryMachine(int index)
        {
            return new Rectangle(index % (Butchery.machineSpriteSheet.Width / 16) * 16, index * 16 / Butchery.machineSpriteSheet.Width * 16 * 2, 16, 32);
        }

        public ButcherArtisanMachine()
        {
        ...
        public override void drawInMenu(SpriteBatch spriteBatch, Vector2 location, float scaleSize, float transparency, float layerDepth, bool drawStackNumber)
        {
            ...
            spriteBatch.Draw(Butchery.machineSpriteSheet, location + new Vector2(Game1.tileSize / 2, Game1.tileSize / 2), new Rectangle?(sourceRectForButcheryMachine), Color.White * transparency, 0f, new Vector2(8f, 16f), Game1.pixelZoom * (scaleSize < 0.2 ? scaleSize : (scaleSize / 2f)), SpriteEffects.None, layerDepth);
        }
        ...
        public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
        {
            ...
            spriteBatch.Draw(Butchery.machineSpriteSheet, destinationRectangle, new Rectangle?(getSourceRectForButcheryMachine(parentSheetIndex)), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, Math.Max(0f, ((y + 1) * Game1.tileSize - Game1.pixelZoom * 6) / 10000f) + ((parentSheetIndex == 105) ? 0.0035f : 0f) + x * 1E-08f);
        }
            ...
            if(dropIn != null)
            {
                ...
                {                
                    if (!probe)
                    {
                        ...
                        isOn = true;
                        //heldObject = new StardewValley.Object(Vector2.Zero, 346, "Beer", false, true, false, false);
                        hasBeenPickedUpByFarmer = false;
                        heldObject = new ButcherArtisanGoods("Smoked " + dropIn.name);
                        ...
                        //heldObject = new StardewValley.Object(420, 1, false, -1, 0);
        ...
        {
           spriteBatch.Draw(Butchery.machineSpriteSheet, objectPosition, new Rectangle?(getSourceRectForButcheryMachine(f.ActiveObject.ParentSheetIndex)), Color.White, 0f, Vector2.Zero, Game1.pixelZoom, SpriteEffects.None, Math.Max(0f, (f.getStandingY() + 2) / 10000f));  
        }
